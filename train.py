...
from data import IGNORE, make_loader
...
def compute_loss(
    detect_logits, correct_logits, detect_labels, correct_labels, lambda_c
):
    """
    detect_logits:  (B, 2)
...
def main():
    ...
    if args.finetune:
        ...
        lr = args.finetune_lr
        print(f"fine-tuning from {args.finetune} at lr={lr}")
    else:
        config = Config(
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if dev_f1 > best_f1:
            ...
            ckpt_name = "finetuned.pt" if args.finetune else "best.pt"
